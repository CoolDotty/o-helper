[Flags]
public enum GraphicsModeSupportSlot : byte
{
    None = 0x00,
    Integrated = 0x01,
    Hybrid = 0x02,
...
public sealed class SystemDesignDataInfo
{
    public static readonly SystemDesignDataInfo Empty = new(0, GraphicsModeSupportSlot.None, GraphicsModeSupportSlot.None, false);
