...
namespace OHelper
{
    partial class AsusMouseSettings
    {
        ...
        private void InitializeComponent()
        {
            ...
            comboBoxPollingRate = new OHelper.UI.RComboBox();
            panelDPISettings = new Panel();
            sliderDPI = new OHelper.UI.Slider();
            ...
            buttonDPIColor = new OHelper.UI.RButton();
            labelDPI = new Label();
            tableDPI = new TableLayoutPanel();
            buttonDPI2 = new OHelper.UI.RButton();
            buttonDPI1 = new OHelper.UI.RButton();
            buttonDPI3 = new OHelper.UI.RButton();
            buttonDPI4 = new OHelper.UI.RButton();
            ...
            buttonLightingZoneScroll = new OHelper.UI.RButton();
            buttonLightingZoneLogo = new OHelper.UI.RButton();
            buttonLightingZoneAll = new OHelper.UI.RButton();
            buttonLightingZoneUnderglow = new OHelper.UI.RButton();
            buttonLightingZoneDock = new OHelper.UI.RButton();
            comboBoxAnimationDirection = new OHelper.UI.RComboBox();
            labelAnimationDirection = new Label();
            checkBoxRandomColor = new CheckBox();
            checkBoxSyncAura = new CheckBox();
            comboBoxAnimationSpeed = new OHelper.UI.RComboBox();
            labelAnimationSpeed = new Label();
            pictureBoxLightingColor = new PictureBox();
            buttonLightingColor = new OHelper.UI.RButton();
            comboBoxLightingMode = new OHelper.UI.RComboBox();
            labelLightingMode = new Label();
            panelLightingHeader = new Panel();
            sliderBrightness = new OHelper.UI.Slider();
            pictureBoxLighting = new PictureBox();
            labelLighting = new Label();
            panelEnergy = new Panel();
            labelLowBatteryWarningValue = new Label();
            comboBoxAutoPowerOff = new OHelper.UI.RComboBox();
            sliderLowBatteryWarning = new OHelper.UI.Slider();
            ...
            buttonSync = new OHelper.UI.RButton();
            panelBottomButtons = new Panel();
            buttonImport = new OHelper.UI.RButton();
            buttonExport = new OHelper.UI.RButton();
            tableLayoutPanel2 = new TableLayoutPanel();
            rButton1 = new OHelper.UI.RButton();
            rButton2 = new OHelper.UI.RButton();
        ...
        private OHelper.UI.RComboBox comboBinding0, comboBinding1, comboBinding2, comboBinding3, comboBinding4, comboBinding5, comboBinding6;
